!!! warning "`/help_docs` is currently disabled"
    ...
    credential-exposure vulnerability ([#2445](https://github.com/The-PR-Agent/pr-agent/issues/2445) — upstream issue):
...
Under the section `pr_help_docs`, the [configuration file](https://github.com/kgforais1/pr-agent-kgforais1/blob/main/pr_agent/settings/configuration.toml) contains options to customize the 'help docs' tool:
