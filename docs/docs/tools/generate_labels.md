...
You can define your own custom labels in the `[custom_labels]` section. See the [custom_labels.toml](https://github.com/kgforais1/pr-agent-kgforais1/blob/main/pr_agent/settings/custom_labels.toml) file for examples.
