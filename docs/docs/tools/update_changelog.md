...
Under the section `pr_update_changelog`, the [configuration file](../../../pr_agent/settings/configuration.toml) contains options to customize the 'update changelog' tool:
